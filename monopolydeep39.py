...
class MonopolyBot(SingleServerIRCBot):
    def __init__(self, ch, nick, server, port, users=None, num_players=6, ws_url=None):
...
if __name__=="__main__":
    MonopolyBot("##rento","rentobot","irc.ipv6.libera.chat",6667,ws_url=os.environ.get("RENTO_WS_URL")).start()
