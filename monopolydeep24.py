        ...
        if body.lower() == "!propertylist":
            try:
                ...
                for delay,pos in enumerate(sorted(self.active_board)):
                    ...
                    threading.Timer(delay * 1.5,lambda p=pos,c=color:self.connection.privmsg("player1bot",f"!dot {p} {c}")).start()
        ...
        if body.lower() == "!up":
            ...
            for i in range(1, 5):
                ...
                if p in self.players:
                    pos.append(str(self.players[p]["pos"]))
                    money.append(str(self.players[p]["money"]))
                    props.append(str(sum(1 for o in self.properties.values() if o == p)))
                    houses.append(str(sum(self.houses.get(pr,0) for pr, own in self.properties.items() if own == p)))
                else:
                    pos.append("0")
                    money.append("0")
                    props.append("0")
            ...
            try:
                msg = " ".join(pos + money + props + houses)
